 ...
 */
static_assert(CFG_SYS_PCIE2_MEM_VIRT == CFG_SYS_PCIE1_MEM_VIRT + SZ_512M);
static_assert(CFG_SYS_PCIE2_MEM_PHYS == CFG_SYS_PCIE1_MEM_PHYS + SZ_512M);

/*
 * PCIe I/O TLB entry expects that all 3 PCIe I/O windows are mapped one after
 * another. Check for this requirement.
 */
static_assert(CFG_SYS_PCIE2_IO_VIRT == CFG_SYS_PCIE1_IO_VIRT + SZ_64K);
static_assert(CFG_SYS_PCIE2_IO_PHYS == CFG_SYS_PCIE1_IO_PHYS + SZ_64K);
static_assert(CFG_SYS_PCIE3_IO_VIRT == CFG_SYS_PCIE2_IO_VIRT + SZ_64K);
static_assert(CFG_SYS_PCIE3_IO_PHYS == CFG_SYS_PCIE2_IO_PHYS + SZ_64K);
